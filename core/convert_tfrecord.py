...
def main(argvs):
    ...
    parser.add_argument("--dataset_txt", default='../raccoon_dataset/labels.txt')
    parser.add_argument("--tfrecord_path_prefix", default='../raccoon_dataset/raccoon_train/wzp_new_train')
    flags = parser.parse_args()
    # dataset_txt = "../raccoon_dataset/labels.txt"
    # tfrecord_path_prefix = '../raccoon_dataset/raccoon_train/wzp_new_train'
    dataset = {}

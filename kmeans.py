...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset_txt", type=str, default="./raccoon_dataset/label_wzp.txt")
    parser.add_argument("--anchors_txt", type=str, default="./data/raccoon_anchors_wzp.txt")
